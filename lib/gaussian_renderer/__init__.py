...
def simple_renderer(
    ...
    # Set the default pipe arguments
    pipe = GroupParams()
    setattr(pipe, "convert_SHs_python", convert_SHs_python)
    setattr(pipe, "compute_cov3D_python", compute_cov3D_python)
    setattr(pipe, "debug", debug)
    setattr(pipe, "antialiasing", antialiasing)
